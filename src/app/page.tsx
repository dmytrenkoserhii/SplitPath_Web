...
import { Book, Brain, ChevronRight, Smartphone, Sparkles, User } from 'lucide-react';
    ...
    <Container size="lg">
      ...
      <Box py={80} ta="center">
        ...
        <Text c="dimmed" mt="md" size="xl" maw={600} mx="auto">
          Experience interactive storytelling powered by AI. Every choice matters, every story is
          unique.
        </Text>
        <Button
          component={Link}
      ...
      <Box py={80}>
        ...
        >
          <ListItem>
            ...
            <Text c="dimmed" mt={5}>
              Select from various genres like fantasy, sci-fi, mystery, or create your own custom
              world
            </Text>
          </ListItem>
          <ListItem>
      ...
      <Box py={80}>
        <Container size="lg">
          ...
          <SimpleGrid cols={{ base: 1, sm: 2, md: 3, xl: 4 }} spacing="xl">
            <StoryPreview
