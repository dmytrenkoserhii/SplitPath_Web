    ...
    <Center style={{ minHeight: '100dvh' }}>
      <Paper shadow="md" radius="md" p="xl" withBorder w={{ base: '90%', sm: 450 }}>
        <Stack gap="md">
          ...
          <Text ta="center">We&apos;ve sent a verification link to your email address.</Text>
          ...
          <Text size="sm" c="dimmed" ta="center" mt="md">
            If you don&apos;t see the email, check your spam folder or try signing in - you can
            request a new verification email from there.
          </Text>
